 ...
 */
const LINKS: string[] = [
  "https://www.youtube.com/watch?v=ZyXjTHdzy5I&list=PLFHiit_0T6mnxqwHwQIih1104GPU8znLS&index=39/?simular=2026-08-15", // Dia 1
...
const TITLES = [
  ...
  "A fé deve aumentar!",
  "",
  "Viver bem uma vocação",
  "Não se contaminar no mundo",
  "Combater a frieza espiritual",
  "Os desertos espirituais",
  "O perdão",
  "A perseverança em Deus",
  "Obediencia ao Papa",
  "O discernimento dos espiritos",
  "Os sonhos não atendidos",
  ...
  "Testemunho sobre a Quaresma",
  "A vigilancia",
  "Os Sacramentos",
  "Não desanimar",
  "A Alegria na vida do Cristão",
]
